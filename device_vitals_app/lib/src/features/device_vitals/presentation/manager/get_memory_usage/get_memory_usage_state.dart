...
class GetMemoryUsageInitial extends GetMemoryUsageState {
...
class GetMemoryUsageLoading extends GetMemoryUsageState {
  const GetMemoryUsageLoading();
  @override
  List<Object?> get props => [];
}

class GetMemoryUsageSuccess extends GetMemoryUsageState {
...
class GetMemoryUsageFailure extends GetMemoryUsageState {
